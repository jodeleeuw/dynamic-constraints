...
df.base <- expand.grid(cond=1:3, t=1:72, position=1:3)
...
ggplot(data.summary, aes(x=t,y=meanrt,colour=cond)) +
  geom_point()+
  geom_line(data=data.posterior.overlay, aes(y=y, group=interaction(i, cond)), alpha=0.25)+
